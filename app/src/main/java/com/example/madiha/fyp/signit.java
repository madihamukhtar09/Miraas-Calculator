...
/**
 * Created by madiha on 1/14/2018.
 */

public class signit extends AsyncTask<String,String,String> {
    ...
    public signit(Context x,String username,String password)
    {
    ...
    protected void onPostExecute(String s) {
        ...
        {
            Intent p=new Intent(x,LogIn.class);
